var ApiAccount = function ($) {
    ...
    var me = {
        ...
        v3ManageBaseUrl: 'index.php?module=api_account&action=list&cmd=v3-page',
        updateV3ManageLink: function (accountId) {
            var href = me.v3ManageBaseUrl;
            if (accountId) {
                href += '&account=' + encodeURIComponent(String(accountId));
            }
            $('#api-v3-manage-link').attr('href', href);
        },
        open: function (id) {
