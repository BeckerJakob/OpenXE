...
class ObjGenProduktion
{
  ...
  private  $lager_ok;
  private  $bestellung_ok;
  private  $bezahlung_ok;
  private  $lieferschein_ok;
  private  $porto_ok;
  private  $ust_ok;
  private  $check_ok;
  private  $vorkasse_ok;
...
$result = $result[0];
    ...
    $this->bestellung_ok=$result['bestellung_ok'];
    $this->bezahlung_ok=$result['bezahlung_ok'];
    $this->lieferschein_ok=$result['lieferschein_ok'];
  ...
  public function Update()
  {
    ...
    $sql = "UPDATE produktion SET
      ...
      bestellung_ok='{$this->bestellung_ok}',
      bezahlung_ok='{$this->bezahlung_ok}',
      lieferschein_ok='{$this->lieferschein_ok}',
 ...
 /** dank dieser funktionen kann man die tatsaechlichen werte einfach 
  ...
  function SetBestellung_Ok($value) { $this->bestellung_ok=$value; }
  function GetBestellung_Ok() { return $this->bestellung_ok; }
  function SetBezahlung_Ok($value) { $this->bezahlung_ok=$value; }
  function GetBezahlung_Ok() { return $this->bezahlung_ok; }
  function SetLieferschein_Ok($value) { $this->lieferschein_ok=$value; }
  function GetLieferschein_Ok() { return $this->lieferschein_ok; }
