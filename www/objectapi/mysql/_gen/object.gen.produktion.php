...
$result = $result[0];
    ...
    $this->bestellungen_ok=$result['bestellungen_ok'];
  ...
  public function Update()
  {
    ...
    $sql = "UPDATE produktion SET
      ...
      bestellungen_ok='{$this->bestellungen_ok}',
 ...
 /** dank dieser funktionen kann man die tatsaechlichen werte einfach 
  ...
  function SetBestellungen_Ok($value) { $this->bestellungen_ok=$value; }
  function GetBestellungen_Ok() { return $this->bestellungen_ok; }
